...
describe JobPool::Job do
  ...
  #     process = JobPool::Job.new('/bin/sh -c "sleep 0.1 && printf done."', chin, chout, cherr)
  ...
  #   elapsed = time do
  #     process = JobPool::Job.new(['sleep', '0.5'], chin, chout, cherr)
  #
  ...
  #   expect {
  #     expect(JobPool.count).to eq 0
  #     process = JobPool::Job.new(['ThisCmdDoes.Not.Exist.'], chin, chout, cherr)
  ...
  #   elapsed = time do
  #     process = JobPool::Job.new(['sleep', '10'], chin, chout, cherr, 0)
  #   end
  #   expect(elapsed).to be < 0.5
  # end
end
